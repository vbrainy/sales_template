        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <span class="box-title"><a class="btn btn-info editBtn" title="Back" style="color: #fff;" data-toggle="tooltip" href="<?php echo base_url(); ?>jobs/index/<?php echo $job->task_id; ?>">
